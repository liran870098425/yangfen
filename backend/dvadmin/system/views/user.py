    ...
    def user_info(self, request):
        ...
        try:
            ...
            if not user or not user.is_authenticated:
                return DetailResponse(data={}, msg="用户未认证")
            ...
            result = {
                ...
                "role": list(user.role.values_list('id', flat=True)) if hasattr(user, 'role') else [],
            }
            ...
            if role:
                result['role_info'] = list(role.values('id', 'name', 'key'))
            return DetailResponse(data=result, msg="获取成功")
        except Exception as e:
            return DetailResponse(data={}, msg=f"获取用户信息失败: {str(e)}")
