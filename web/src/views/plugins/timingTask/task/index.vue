    ...
    >
      <div slot="header">
        ...
        <el-button-group>
          ...
          <el-button size="small" type="danger"  :disabled="!multipleSelection || multipleSelection.length===0" @click="batchDelete"><i class="el-icon-delete"></i> 批量删除</el-button>
        </el-button-group>
        <crud-toolbar
      ...
      <!--页面字段得自定义处理-->
      <template slot="crontab_strSlot" slot-scope="scope">
        <el-tag size="mini">{{scope.row['crontab_str']}}</el-tag>
      </template>
    </d2-crud-x>
